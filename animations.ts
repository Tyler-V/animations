...
export class Animate {
    public static scrollLeft(element: HTMLElement, end: number, duration: number, easing?: EasingFunctions, callback?: () => void) {
        this.animate(element, HTMLElementProperty.scrollLeft, end, duration, easing, () => callback());
    }
     ...
     */
    private static animate(element: HTMLElement, property: HTMLElementProperty, end: number, duration: number, easing: EasingFunctions, callback?: () => void) {
        if (property == HTMLElementProperty.scrollLeft) {
            if (element.scrollLeft == end) return callback();
        }
